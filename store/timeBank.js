export const state = () => ({
  ...
  statusArry:
    { EX124: 0, LN034: 0, LNB035: 0, MC009: 0, MC010: 0, MC024: 0, MC026: 0, MC027: 0, MC028: 0, MC031: 0, MC037: 0, GT111: 0, GT999: 0, MC009: 0, MC010: 0, MC011: 0, MC013: 0, RW046: 0, RW052: 0 },
...
export const mutations = {
  GuntArryPush(state,{GuntStart,GuntHorizon,y,NowState,machine}){
    ...
    //ガントチャート　確認用
    // if(machine=="MC031"){
    //   console.log(machine+'--'+GuntStart+"---"+GuntHorizon+"---"+"---"+y+"---"+NowState)
    // }
